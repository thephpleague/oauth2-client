...
class Concrete5Test extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->provider = new \League\OAuth2\Client\Provider\Concrete5(
            array(
    ...
    public function testUrlAccessToken()
    {
        ...
        $this->assertEquals('/api/v1/-/token', $uri['path']);
    }
    ...
    public function testUserData()
    {
        ...
        $postResponse->shouldReceive('getBody')->times(1)->andReturn(
            '{"access_token":"mock_access_toke","expires_in":3600,"token_type":"Bearer","scope":null,"refresh_token":"mock_refresh_token"}');

        $getResponse = m::mock('Guzzle\Http\Message\Response');
        $getResponse->shouldReceive('getBody')->andReturn(
            '{"id":"44","email":"mock_email","timezone":null,"username":"mock_username","first_name":"mock_firstname","last_name":"mock_lastname"}');

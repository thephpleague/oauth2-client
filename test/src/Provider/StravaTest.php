...
class StravaTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->provider = new \League\OAuth2\Client\Provider\Strava(array(
...
#    print_r($token);die();
    ...
    public function testUserData()
    {
        ...
        $getResponse->shouldReceive('getBody')->times(1)->andReturn('{"id": 12345, "firstname": "mock_first_name", "lastname": "mock_last_name", "email": "mock_email", "country": "NL", "sex": "M", "profile": "profile_url"}');
